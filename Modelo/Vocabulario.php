...
class Vocabulario
{
	...
	public function crearVocabulario($name,$description,$image,$audio,$idCate,$idSub)
	{
		$this->Conexion=Conectarse();
		$sql = "INSERT INTO vocabulary (Name,image,audio,description,idvocabulary_idcategoria,idvocabulary_idsubcategoria)VALUES('$name','$image','$audio','$description','$idCate','$idSub')";
